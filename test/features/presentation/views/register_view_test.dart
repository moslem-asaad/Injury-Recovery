...
void main() async {
  ...
  /*testWidgets('Register Page Test - Successful Registration',
    ...
    expect(find.text('ברוך שוב, התגעגענו !'), findsOneWidget);
  });*/
  ...
  testWidgets('Register Page Test - Password Mismatch',
    ...
    expect(find.text('Confirmed Password does not match'), findsOneWidget);
  });
/*
  testWidgets('Register Page Test - already registerd',
      (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(home: RegisterView()));
    ...
    await tester.enterText(find.byType(TextField).at(3), 'moslem.asaad2000@gmail.com');
    ...
    expect(find.text('הדואר האלקטרוני כבר רשום'), findsOneWidget);
  });*/
}